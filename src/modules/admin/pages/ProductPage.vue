          ...
          <span class="text-red-400" v-if="errors.title">{{ errors.title }}</span> -->
            ...
            <div class="flex flex-row gap-3">
                <div class="mb-4 flex-1">
                    ...
                    <CustomInput label="price" v-model.number="price" v-bind="priceAttrs" :error="errors.price" />
                </div>

                <div class="mb-4 flex-1">

                    <CustomInput label="stock" v-model.number="stock" v-bind="stockAttrs" :error="errors.stock" />
                </div>
            </div>
