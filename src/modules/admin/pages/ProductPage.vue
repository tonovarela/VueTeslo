        ...
        <div class="first-col">
            ...
            <div class="mb-4">
                ...
                <textarea id="description"
                    class="shadow h-32 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex">
                    <button v-for="size of allSizes" :key="size" type="button"
                        class="bg-blue-100 flex-1 p-2 rounded w-14 mr-2">{{
                            size }}</button>
                </div>
...
<script src="./ProductPage.ts" lang="ts">
</script>
